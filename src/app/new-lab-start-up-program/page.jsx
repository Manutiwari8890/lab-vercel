        ...
        <>
            <section className="py-10">
                <div className="container px-2 mx-auto lg:px-5">
                    <h2 className="text-2xl mx-auto font-semibold uppercase text-dark page-title mb-5 md:mb-10 md:text-3xl xl:mb-15">New Lab Start up Program</h2>
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:gap-15">
                        <div className="img-area">
                            <img src="/assets/images/New-lab-startup.jpg" className="w-full" alt="" />
                        </div>
                        <div className="relative xl:pl-4 xl:pr-2">
                            <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">Partner with Our Team – Your Dedicated Project Manager under New Lab Start Up Program (NLSP) Will Help You Create a Comprehensive Plan for Your New Lab Startup, Ensuring Everything is Completed in a Timely Manner and as per Your Needs.</p>
                            <p className="text-base text-gray-500 text-justify mb-6 md:mb-3 xl:mb-5">Explore Our Product Catalog – From Reagents to Instruments, We Provide All the Supplies and Equipment You Need to Start Your Lab on the Right Foot. Ready to Get Your Lab Started? Apply Now for New Lab Start Up Program (NLSP).</p>
