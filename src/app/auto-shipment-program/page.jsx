        ...
        <>
            <section className="py-10">
                <div className="container px-2 mx-auto lg:px-5">
                    <h2 className="text-2xl mx-auto font-semibold uppercase text-dark page-title mb-5 md:mb-10 md:text3xl xl:mb-15">Auto Shipment Program</h2>
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:gap-15">
                        <div className="img-area">
                            <img src="/assets/images/Auto_Shipment_Program_img.jpg" className="w-full" alt="" />
                        </div>
                        <div className="relative xl:pl-4 xl:pr-2">
                            <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">Never worry about running out of your important products again! Sign up for our auto shipment program at labdisposable.com and we’ll make sure your items are delivered straight to your doorstep on a schedule that works for you.</p>
                            <p className="text-base text-gray-500 text-justify mb-6 md:mb-3 xl:mb-5">Our auto shipment program is perfect for busy individuals who want the ease of regular deliveries. We also offer exclusive rates for this program based on quantity, frequency and commitment period. So apply now and executive from our side will contact you.</p>
                            <h3 className="text-2xl mx-auto font-semibold text-dark mb-3 xl:mb-5">Apply Now</h3>
                            <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-2 gap-4 gap-y-2 xl:gap-y-0">
