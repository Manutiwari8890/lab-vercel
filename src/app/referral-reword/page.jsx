        ...
        <>
            <section className="py-10">
                <div className="container px-3 mx-auto md:px-5">
                   <h2 className="text-2xl mx-auto font-semibold uppercase text-dark page-title mb-5 md:mb-10 md:text-3xl xl:mb-15">Referral Rewards Programs</h2>
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:gap-15">
                        <div className="relative xl:pl-4 xl:pr-2">
                            <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">At Laboratory Disposable Products, we provide personalized attention to help our customers select the right laboratory products and supplies that match both their requirements and budget.</p>
                            <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">We are committed to fast and reliable service, and most of our products are delivered earlier than expected. To ensure quick fulfillment and consistent availability, we maintain a well-stocked central inventory.</p>
                            <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">Your satisfaction means everything to us. If you are happy with our service, quality, and pricing, we invite you to refer Laboratory Disposable Products to your colleagues and friends.</p>
                            <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">Our Referral Rewards Program (RRP) is designed to thank you for your trust and works in two rewarding ways.</p>
                            <ul className="text-base text-gray-500 text-justify mb-2 xl:mb-3">
                                <li>• Share their contact information with us, and we will reach out to them.</li>
                                <li>• Tell your friends about Laboratory Disposable Products and ask them to contact us, mentioning your reference.</li>
                            </ul>
                              <p className="text-base text-gray-500 text-justify mb-2 xl:mb-3">In both cases, you will receive a discount on your next order as a  appreciation.</p>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-2 gap-4 gap-y-2 xl:gap-y-3">
                                    ...
                                    <div className="form-group mb-1 relative">
                                        ...
                                        <textarea maxLength="200" className="w-full border border-[#afafaf] py-4 px-4 text-sm font-semibold focus:border-primary" id="comments" placeholder="Comments"></textarea>
                                    </div>
                        ...
                        <div className="img-area -order-1 md:order-1">
                            <img src="/assets/images/RRP_img.jpg" className="w-full" alt="" />
                        </div>
                    </div>
