...
export default function Page() {
    ...
    return (
        <>
            <section className="bg-[#FAFAFA] py-12 min-h-[50vh] xl:min-h-[80vh]">
                <div className="container px-2 mx-auto lg:px-5">
                    <div className="text-center content-center">
                        <h2 className="text-3xl font-semibold uppercase text-dark page-title text-center mb-10 mx-auto">Register</h2>
                        <div className="bg-white shadow-lg px-10 py-5 max-w-[500px] mx-auto">
                            ...
                            <form onSubmit={(e) => handlesubmit(e)}>
                                <div className="form-group mb-3 relative">
                                    <label htmlFor="name" className="text-left text-sm font-semibold inline-block w-full mb-2">Name</label>
                                    <input type="text" className={`peer w-full border py-4 pr-4 pl-12 text-sm font-semibold focus:border-primary ${formErrors?.name ? "border-red-500" : "border-[#E4DFDF]"}`} id="name" placeholder="Your Name" onChange={(e) => setName(e.target.value)} value={name} />
                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="27" viewBox="0 0 19 27" fill="none" className={`absolute top-[44px] left-[4%] peer-focus:text-primary transition-colors duration-200 ${formErrors?.name ? "text-red-500" : "text-[#807A7A]"}`}>
                                        <ellipse cx="9.28374" cy="7.07427" rx="5.22027" ry="5.22027" stroke="currentColor" strokeWidth="1.78782" strokeLinecap="round" strokeLinejoin="round"></ellipse>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M1.00783 22.043C1.00643 21.676 1.0885 21.3135 1.24784 20.9829C1.74787 19.9829 3.15794 19.4528 4.328 19.2128C5.17185 19.0327 6.02735 18.9124 6.88813 18.8528C8.48181 18.7128 10.0847 18.7128 11.6784 18.8528C12.5391 18.9131 13.3945 19.0334 14.2385 19.2128C15.4086 19.4528 16.8186 19.9329 17.3187 20.9829C17.6391 21.6568 17.6391 22.4391 17.3187 23.113C16.8186 24.1631 15.4086 24.6431 14.2385 24.8731C13.3957 25.0606 12.5398 25.1843 11.6784 25.2431C10.3813 25.3531 9.07807 25.3731 7.77818 25.3031C7.47816 25.3031 7.18815 25.3031 6.88813 25.2431C6.02989 25.1851 5.17736 25.0614 4.338 24.8731C3.15794 24.6431 1.75787 24.1631 1.24784 23.113C1.08932 22.7786 1.00732 22.4131 1.00783 22.043Z" stroke="currentColor" strokeWidth="1.78782" strokeLinecap="round" strokeLinejoin="round"></path>
                                    </svg>
                                    {formErrors?.name && <p className="text-sm font-semibold text-red-500 text-left mt-1">{formErrors?.name}</p>}
                                </div>
                                <div className="form-group mb-3 relative">
                            ...
                            <p className="text-base font-semibold">Already have an account ? <Link href="/login" className="text-secondary ml-2 hover:text-primary">Login</Link></p>
                        </div>
                    </div>
                </div>
            </section>
